...
function InterActiveStory({ pageName = "قصة تفاعلية جديدة" }) {
  ...
  const validateForm = () => {
    const newErrors = {};
    if (!form.title.trim()) newErrors.title = "عنوان القصة مطلوب";
    if (!form.description.trim()) newErrors.description = "وصف القصة مطلوب";
    if (!form.genre) newErrors.genre = "يرجى اختيار نوع القصة";
    if (!form.ageRange) newErrors.ageRange = "يرجى تحديد الفئة العمرية";
    if (!form.cover) newErrors.cover = "غلاف القصة مطلوب";
    if (!form.sceneNum) newErrors.sceneNum = "يرجى اختيار عدد المشاهد";
    if (!form.optionNum) newErrors.optionNum = "يرجى اختيار عدد الخيارات";
  ...
  const handleSubmit = () => {
    ...
    console.log("تم إنشاء القصة:", form);
  ...
  return (
    <div className="min-h-screen bg-[var(--earth-cream)] rtl" dir="rtl">
      ...
      <Navbar
        mobileButtonTitle="حفظ"
        onMobileButtonPress={handleSubmit}
        pageName={pageName}
        collapsed={collapsed}
            ...
            <div className="max-w-5xl mx-auto space-y-6">
              ...
              <div className="bg-white rounded-xl border border-[var(--earth-brown)]/10 p-8 hover:border-[var(--earth-brown)]/20 transition-colors duration-200 shadow-sm">
                ...
                <label
                  ...
                  className="flex flex-col items-center justify-center w-full h-56 border-2 border-dashed border-[var(--earth-brown)]/20 rounded-lg cursor-pointer hover:border-[var(--earth-brown)]/40 hover:bg-[var(--earth-cream)] transition-all duration-200 group"
                >
              ...
              <div className="flex justify-center pt-6 pb-12">
                <button
                  ...
                  className="px-12 py-4 rounded-xl bg-[var(--earth-brown)] text-white font-semibold text-lg hover:opacity-90 transition-all duration-200 shadow-lg hover:shadow-xl"
                >
                  إنشاء القصة التفاعلية
                </button>
              </div>
            </div>
          </div>
