...
export default function LoginPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!validate()) return;
    navigate("/Screens/dashboard/controlBoard");
  };
      ...
      >
        ...
        >
          <img
            src={owlLogin}
            alt="owl"
            className="w-[360px] h-auto drop-shadow-[0_24px_60px_rgba(0,0,0,0.55)] mx-auto"
          />

          <h2 className="text-3xl md:text-4xl font-bold text-[#fdf7ee] mt-10">
            مرحباً بك في كتّاب
          </h2>

          <p className="text-[#f5e9db]/80 text-lg mt-4 leading-relaxed max-w-md mx-auto">
